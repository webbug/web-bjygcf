window.onload = function () {
    ...
    oPrev.style.left = 350 + 650 / 2 + aImg[0].offsetWidth / 2 - oPrev.offsetWidth - 14 + 'px';
    oNext.style.left = 855 / 2 - aImg[0].offsetWidth / 2 + oPrev.offsetWidth - 15 + 'px';
    ...
    (function () {
        ...
        oS.src='http://www.zhinengshe.com/zpi/zns_demo.php?id=3541';
