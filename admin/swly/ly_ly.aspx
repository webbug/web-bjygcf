<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ly_ly.aspx.cs" Inherits="admin_about_yjfk_ab" %>
    ...
    <div class="site-content services">
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="id" DataSourceID="SqlDataSource1">
                <ItemTemplate>
                    <li>
                        <h2>
                            <a href="#" title="">
                                <%#Eval("ly_title").ToString().Length > 20 ? Eval("ly_title").ToString().Substring(0, 20) + "..." : Eval("ly_title")%></a>
                        ...
                        <div>
                            <div class="service-content">
                                ...
                                <a href="del.aspx?cz=sc&bm=bjygcf_ly&id=<%#Eval("id") %>"
                                        title="Delete" style="">
            ...
            <ul class="services-list">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT [id], [ly_name], [ly_sex],[ly_time], [ly_phone], [ly_title],[ly_context] FROM [bjygcf_ly] ORDER BY [id] DESC">
                </asp:SqlDataSource>
            </ul>
    </div>
