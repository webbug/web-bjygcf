<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tjxqts.aspx.cs" Inherits="swly_tjxqts" %>
    ...
    <div>
        ...
        <p>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" class="text-input" Width="125px">第一天</asp:TextBox>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="false">
            ...
            <div id="img1" style="display: block">
                ...
                <asp:TextBox ID="imgtext1" runat="server" Visible="False"></asp:TextBox>
                <asp:TextBox ID="imgtext2" runat="server" Visible="False"></asp:TextBox>
                <br />
            </div>
