<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ly_lb.aspx.cs" Inherits="admin_swly_ly_lb" %>
        ...
        <div class="content-box-content">
            <div class="tab-content" id="tab2">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    ...
                    SelectCommand="SELECT [dq], [country], [showid], [lx], [yh], [id], [name], [price], [hprice], [hotel], [days], [times], [ts], [xq], [zst], [yh2] FROM [bjygcf_lyxl] ORDER BY [showid], [id] DESC">
                </asp:SqlDataSource>
                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <!-- Icons -->
                                <a href="ly_up.aspx?lyid=<%#Eval("id") %>" title="Edit">
                                    <img src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a href="del.aspx?cz=sc&bm=bjygcf_lyxl&id=<%#Eval("id") %>"
                                        title="Delete">
