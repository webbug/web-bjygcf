<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jrgl_lb.aspx.cs" Inherits="admin_swly_ly_lb" %>
        ...
        <div class="content-box-content">
            <div class="tab-content" id="tab2">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    ...
                    SelectCommand="SELECT * FROM [bjygcf_jrgl] ORDER BY [id] DESC">
                </asp:SqlDataSource>
                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%#Eval("jj").ToString().Length>=50?Eval("jj").ToString().Substring(0,50)+"...":Eval("jj") %>
                            </td>
                           
                          
                            <td>
                                <!-- Icons -->
                                <a href="jrgl_ad.aspx?jrglid=<%#Eval("id") %>" title="Edit">
                                    <img src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a href="del.aspx?cz=sc&bm=bjygcf_jrgl&id=<%#Eval("id") %>"
                                        title="Delete">
                                ...
                                <td id="Td" runat="server">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" style="">
                                        <tr id="Tr2" runat="server" style="">
                                            <th id="Th1" runat="server" width="25%">
                                                攻略标题
                                            </th>
                                            <th id="Th2" runat="server" width="65%">
                                                攻略简介
                                            </th>
