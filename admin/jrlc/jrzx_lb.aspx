<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jrzx_lb.aspx.cs" Inherits="admin_swly_ly_lb" %>
        ...
        <div class="content-box-content">
            <div class="tab-content" id="tab2">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    ...
                    SelectCommand="SELECT * FROM [bjygcf_jrzx] ORDER BY [showid] DESC">
                </asp:SqlDataSource>
                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                    <ItemTemplate>
                        <tr>
                            <td>
                                <%#Eval("title").ToString().Length >= 25? Eval("title").ToString().Substring(0, 25) + "..." : Eval("title")%>
                            </td>
                            <td>
                                <%#Eval("zjj").ToString().Length>=53?Eval("zjj").ToString().Substring(0,53)+"...":Eval("zjj") %>
                            </td>
                            <td>
                                <%#Eval("showid") %>
                            </td>
                            ...
                            <td>
                                <!-- Icons -->
                                <a href="jrzx_ad.aspx?zxid=<%#Eval("id") %>" title="Edit">
                                    <img src="../resources/images/icons/pencil.png" alt="Edit" /></a> <a href="del.aspx?cz=sc&bm=bjygcf_jrzx&id=<%#Eval("id") %>"
                                        title="Delete">
                                ...
                                <td id="Td" runat="server">
                                    <table id="itemPlaceholderContainer" runat="server" border="0" style="">
                                        <tr id="Tr2" runat="server" style="">
                                            ...
                                            <th id="Th2" runat="server" width="50%">
                                                资讯简介
                                            </th>
