jQuery(document).ready(function () {
    ...
    //自动轮播器
    var ban_timer = setInterval(function () { banner_fn(); }, 6000);
    ...
    jQuery(' #lun_dian li').hover(function () {
        ...
        ban_timer = setInterval(function () { banner_fn() }, 6000);   //切记没有 var
    ...
    var timer = setInterval(function () {
        ...
        num++;
        if (num == jQuery('#mx .mx_head div ul').length) {
            num = 0;
            setTimeout(function () {
