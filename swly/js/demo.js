jQuery(document).ready(function () {
    ...
    $(window).resize(function () {
        ...
        getScroll().left = 0;
        jQuery('#hea .na_bg').css({
            width: getScroll().left + getInner().width - 1
        });
    });
    //一格客服初始化位置
    ...
    //end
    //一格客服初始化位置
    $('#share_gai').css('top', getScroll().top + (getInner().height - parseInt(getStyle($('#share').first(), 'height'))) /
        2 + 'px');
    //end
    /* //一格客服左右伸缩
    ...
    //end*/
    //一格客服左右伸缩
    jQuery('#share_gai').hover(function () {
        jQuery(this).stop().animate({
            width: '309px'
        });
    ...
    jQuery(window).bind('scroll', function () {
        jQuery('#share').css({
            right: -getScroll().left
        });
        jQuery('#share_gai').css({
            right: -getScroll().left
        });
